...
function CreateArchive() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error(err);
      setError(
        err instanceof Error ? err.message : "Failed to create archive job",
      );
    } finally {
      setIsLoading(false);
    }
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent className="max-w-xs space-y-2 p-4">
                        <p>
                          <span className="font-bold">page</span>: crawl only
                          this page and no additional links.
                        </p>
                        <p>
                          <span className="font-bold">page-spa</span>: crawl
                          only this page, but load any links that include
                          different hashtags. Useful for single-page apps that
                          may load different content based on hashtag.
                        </p>
                        <p>
                          <span className="font-bold">prefix</span>: crawl any
                          pages in the same directory, eg. starting from
                          https://example.com/path/page.html, crawl anything
                          under https://example.com/path/ (default)
                        </p>
                        <p>
                          <span className="font-bold">host</span>: crawl pages
                          that share the same host.
                        </p>
                        <p>
                          <span className="font-bold">domain</span>: crawl pages
                          that share the same domain and subdomains, eg. given
                          https://example.com/ will also crawl
                          https://anysubdomain.example.com/
                        </p>
                        <p>
                          <span className="font-bold">any</span>: crawl any and
                          all pages linked from this page.
                        </p>
                      </TooltipContent>
                    </Tooltip>
                  </div>

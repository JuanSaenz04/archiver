            ...
            <Popover>
              <PopoverTrigger asChild>
                ...
                >
                  ...
                  {selectedTags.length > 0 && (
                    <Badge
                      variant="secondary"
                      className="h-4 px-1 text-[10px] ml-1 bg-primary text-primary-foreground hover:bg-primary/90"
                    >
                      {selectedTags.length}
                    </Badge>
                  )}
              ...
              <PopoverContent className="w-56 p-2" align="end">
                <div className="space-y-2">
                  <div className="text-xs font-semibold px-2 py-1 text-muted-foreground uppercase tracking-wider">
                    Filter by Tags
                  </div>
                  ...
                  filteredArchives.map((archive) => (
                    <SidebarMenuItem key={archive.id}>
                      ...
                      <SidebarMenuAction
                        ...
                        aria-label={`Details for ${archive.name}`}
                      >
